...
import { ArrowLeft, HeartHandshake, MapPin, Sparkles } from "lucide-react";
 ...
 * CTA 가 도달하는 페이지.
 *
 * GET /compatibility/date-recommendation 로 LLM 이 추천한 4~5개 장소
 * 카테고리 + overview 노출. (백엔드에서 무료 제공 — 수익모델은 카드 열람.)
 */
