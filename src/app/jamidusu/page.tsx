  ...
  return (
    <AppShell>
      <div className="flex-1 px-[20px]">
        ...
        <section className="mt-[24px] rounded-[14px] border border-white/10 bg-white/5 p-[16px]">
          <h3 className="text-[14px] font-semibold text-white">
            🔮 미리보기 ({me?.nickname ?? "나"}님 자미두수 일부)
          </h3>
          <p className="mt-[8px] text-[12px] leading-[20px] text-white/70">
            <span className="text-white/50">命宮(명궁): </span>
            결제 후 공개됩니다
            <br />
            <span className="text-white/50">財帛宮(재백궁): </span>
            결제 후 공개됩니다
            <br />
            <span className="text-white/50">夫妻宮(부처궁): </span>
            결제 후 공개됩니다
          </p>
        </section>
