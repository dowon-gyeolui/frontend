          ...
          <Section title="9. 사업자 정보">
            <Table
              ...
              rows={[
                ["상호", "멜로비"],
                ["대표자", "김병철"],
                ["사업자등록번호", "315-03-92937"],
                ["통신판매업 신고번호", "신고 진행 중"],
                ["사업장 주소", "서울특별시 강남구 강남대로 354, 11층 889호(역삼동, 혜천빌딩)"],
                ["고객센터 전화", "010-9363-8833"],
                ["연락처 이메일", "thunderbolt9410@gmail.com"],
              ]}
            />
            <P small>
              ※ 통신판매업 신고 진행 중이며, 신고 완료 후 통신판매업 신고번호가
              갱신됩니다.
            </P>
          </Section>
        </div>
